...
public class RelationSerializer extends StdSerializer<AnnotatedRelation>{
    
    public RelationSerializer() {
        this(null);
    }

    protected RelationSerializer(Class<AnnotatedRelation> t) {
        super(t);
    }

    @Override
    public void serialize(AnnotatedRelation value, JsonGenerator gen, SerializerProvider provider) throws IOException {
